...
Public Class MAJs
    Private Sub MAJs_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim currentVersion As New Version("3.0.3")
        ...
        If latestVersion IsNot Nothing AndAlso latestVersion > currentVersion Then
            MessageBox.Show("Une nouvelle version est disponible : " & latestVersion.ToString(), "Mise à jour disponible", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
        Me.Close()
    End Sub
